...
const stacks: StackItem[] = [
  {
    ...
    name: "React",
    description:
      "Bibliothèque JavaScript que j'utilise pour créer des interfaces utilisateurs",
    color: "#61DAFB",
  },
  {
    icon: SiTailwindcss,
    name: "Tailwind CSS",
    description:
      "Framework CSS utilitaire. Je l'utilise pour un design rapide et flexible",
    color: "#06B6D4",
  },
  {
    icon: SiLaravel,
    name: "Laravel",
    description:
      "Framework PHP robuste qui me sert à créer des applications web modernes",
    color: "#FF2D20",
  },
  {
    icon: SiNextdotjs,
    name: "Next.js",
    description:
      "Framework React qui me sert à produire des applications web avec SSR et SSG",
    color: "#gray-500",
  },
  {
    icon: SiFlutter,
    name: "Flutter",
    description:
      "SDK qui me sert à développer des applications multiplateformes",
    color: "#02569B",
  },
  {
    icon: SiMysql,
  ...
  return (
    <section id="about" className="py-20">
      <div className="container mx-auto px-4">
        ...
        >
          Développeur Full Stack passionné par les nouvelles technologies et
          l’innovation. Créatif et orienté solution, j’aime transformer les
          idées en expériences numériques intuitives et performantes. <br /> <span className="text-[hsl(var(--title))]">Mon
          objectif :</span> concevoir des applications web et mobiles légantes et 
        ...
        >
          ...
          <p className="text-lg text-[hsl(var(--muted-foreground))] max-w-2xl mx-auto mb-12 text-center">
            ...
            vos projets. Mon expertise couvre un large éventail de solutions
            ...
            return (
              ...
              >
                <div className="flex flex-col items-center text-center gap-3">
                  <Icon size={32} style={{ color: stack.color }} />
